      ...
      {user?.email ? (
        <div>
          {user?.authority === '제품제조사' && (
            <Link to="/product">
              <button className="text-indigo-600 bg-white border-white px-4 py-2 hover:border-indigo-600">
                Products
              </button>
            </Link>
          )}
          {user?.authority === '부품공급사' && (
            <Link to="/part">
              <button className="text-red-500 bg-white border-white px-4 py-2 mx-2 hover:border-red-500 hover:text-red-500">
                Parts
              </button>
            </Link>
          )}
