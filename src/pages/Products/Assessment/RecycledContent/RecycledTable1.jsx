  ...
  return (
    <TableContainer>
      <Table sx={{ minWidth: 300 }} size="small">
        <TableBody>
          <TableRow>
            <TableCell align="center" style={{ border: '1px solid black' }}>Recycled Type</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>재생소재 함유량</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>재생소재 함유율</TableCell>
          </TableRow>
          <TableRow>
            <TableCell align="center" style={{ border: '1px solid black' }}>Pre Consumer</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>{preConsumerValue}</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>{preConsumerRatio}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell align="center" style={{ border: '1px solid black' }}>Post Consumer</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>{postConsumerValue}</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>{postConsumerRatio}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell align="center" style={{ border: '1px solid black' }}>Unspecified</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>{unspecifiedValue}</TableCell>
            <TableCell align="center" style={{ border: '1px solid black' }}>{unSpecifiedRatio}</TableCell>
          </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
