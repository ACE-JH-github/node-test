...
export default function SignUp() {
  ...
  return (
    <div className={classes.container}>
      <Typography variant="h4" component="h1" className={classes.customHeader}>
        Sign Up
      </Typography>
      <div className={classes.formContainer}>
        <form className={classes.form} onSubmit={handleSubmit}>
          ...
          <ValidatedTextField
            ...
            value={department}
            onChange={(e) =>
              handleChange(e, setDepartment, setDepartmentTouched)
            }
          ...
          <FormControl className={classes.formControl} error={authorityError}>
            ...
            <Select
              ...
              value={authority}
              onChange={(e) =>
                handleChange(e, setAuthority, setAuthorityTouched)
              }
