    ...
    <>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={4}>
          ...
          <TextField id="outlined-basic" label="Part Serial Name" variant="outlined" size='small' sx={{ minWidth: '100%', mb: 2, color: 'black', backgroundColor: '#d3d3d3' }} value={serialName} disabled />
        </Grid>
        {/* Material Group 항목 */}
        <Grid item xs={4}>
          <Typography variant="subtitle1" mb={1}>
        ...
        <Grid item xs={4}>
          ...
          <FormControl variant="outlined" size="small" sx={{ minWidth: '100%', maxWidth: '100%', mb: 2 }}>
            <InputLabel id="select-material-name-label">Select a Group</InputLabel>
            <Select
        ...
        <Grid item xs={4}>
          ...
          <TextField
            ...
            size="small"
            value={partMass}
            sx={{ minWidth: '100%', mb: 2, color: 'black', backgroundColor: '#d3d3d3' }}
            disabled
          />
        </Grid>
